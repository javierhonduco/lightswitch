...
/// For a given executable path retrieved from procfs /map_files, return its
/// absolute path. If the executable is running in a mount namespace it'll
/// return the procfs full mount path.
///
